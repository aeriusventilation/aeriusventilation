<h1 align="center">Aerius Ventilation AB</h1>

<p align="center">
  <strong>Better ventilation. Healthier life.</strong><br>
  Stockholm-based ventilation company serving 30,000+ customers across Sweden since 2015.
</p>
...
| Category | What we do |
|---|---|
| **FTX Systems** | Installation, unit replacement, service & filter changes |
| **Mechanical Exhaust** | F-system installation, fan replacement, centralised ventilation |
| **Ventilation Service** | Duct cleaning, airflow measurement, balancing, troubleshooting |
| **OVK Inspections** | Mandatory ventilation inspections for all building types |
...
- **In-house team** — fully employed engineers and technicians, no subcontractors
- **Transparent pricing** — fixed quotes with clear breakdowns before any work begins
- **Digital-first** — online booking, digital reports, and seamless communication
- **4.5/5 customer rating** — based on thousands of verified reviews
